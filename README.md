...
[![Last Update](https://img.shields.io/github/last-commit/ben-vargas/ai-claude-code-docs/main.svg?label=docs%20updated)](https://github.com/ben-vargas/ai-claude-code-docs/commits/main)
...
Regardless of which version you have installed, simply run from your local checkout:
...
3. Check if GitHub Actions are running: [View Actions](https://github.com/ben-vargas/ai-claude-code-docs/actions)
...
- 🪟 **Windows Support**: Want to help add Windows compatibility? [Fork the repository](https://github.com/ben-vargas/ai-claude-code-docs/fork) and submit a PR!
- 🐛 **Bug Reports**: Found something not working? [Open an issue](https://github.com/ben-vargas/ai-claude-code-docs/issues)
- 💡 **Feature Requests**: Have an idea? [Start a discussion](https://github.com/ben-vargas/ai-claude-code-docs/issues)
...
If you find any issues not listed here, please [report them](https://github.com/ben-vargas/ai-claude-code-docs/issues)!
