...
migrate_installation() {
    ...
    git clone -b "$INSTALL_BRANCH" https://github.com/ben-vargas/ai-claude-code-docs.git "$INSTALL_DIR"
    cd "$INSTALL_DIR"
...
if [[ -f "$INSTALL_DIR/scripts/claude-docs-helper.sh.template" ]]; then
    ...
    echo "  ❌ Helper template missing in repository."
    echo "  This installer is self-contained and will not download from external sources."
    echo "  Ensure your fork contains scripts/claude-docs-helper.sh.template and re-run:"
...
When reading a doc:
📚 COMMUNITY MIRROR: https://github.com/ben-vargas/ai-claude-code-docs
...
• 5 hours ago:
  📎 https://github.com/ben-vargas/ai-claude-code-docs/commit/eacd8e1
  📄 data-usage: https://docs.anthropic.com/en/docs/claude-code/data-usage
     ➕ Added: Privacy safeguards
  📄 security: https://docs.anthropic.com/en/docs/claude-code/security
     ✨ Data flow and dependencies section moved here

📎 Full changelog: https://github.com/ben-vargas/ai-claude-code-docs/commits/main/docs
